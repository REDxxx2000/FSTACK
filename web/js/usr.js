...
var heroG = this.document.getElementById('heroG');
...
function loader() {this.window.setTimeout(fadeout, 3000);
    ...
    function fadeout() {
        ...
        heroG.style.cssText="opacity:100;";
...
function editXt(){
  ...
  del = this.document.getElementById('del');

  var x1 = this.document.getElementById('x1');
  var x2 = this.document.getElementById('x2');
  var x3 = this.document.getElementById('x3');
  var x4 = this.document.getElementById('x4');
  var x5 = this.document.getElementById('x5');
  var x6 = this.document.getElementById('x6');

  del.style.cssText="display:none;opacity:0;";
  btn.style.cssText="display:box;opacity:100;";
  x1.style.cssText="display:box;opacity:100;";
  x2.style.cssText="display:box;opacity:100;";
  x3.style.cssText="display:box;opacity:100;";
  x4.style.cssText="display:box;opacity:100;";
  x5.style.cssText="display:box;opacity:100;";
  x6.style.cssText="display:box;opacity:100;";
  mail.disabled=false;
  pass.disabled=false;
  nam.disabled=false;
  age.disabled=false;
...
function valUsr(){
  ...
  if(mail.value!=''&&pass.value!=''&&nam.value!=''&&age.value!=''&&ctry.value!=''&&usr.value!=''){
    ...
    //alert(mm+'  mail '+pp+'  pass '+nn+'  txt '+aa+'  nmbr '+cc+'  txt '+usr+'  pass ');

  ...
  <section id="hai0" style="opacity:0;display: none;"  class="hero-section">
    ...
    <div id="heroes" class="container">
      <br>
        ...
        <img ID="imgCarTT" src="../images/usr.jpg"/>
    ...
    <br>
        ...
        <a id="fPass" onclick="forPassw();"  class="link-dark link-underline-opacity-65 link-underline-opacity-25-hover link-opacity-25-hover link-offset-3">Did you forgot your password?</a>
